                            ...
                            <center>
                                <div style="width: 500px; height: 100%; overflow: hidden;">
                                    <img style="width: 100%; cursor: pointer;"
                                         ...
                                         src="assets/images/blogs_IT/{{$blog->image ?? './dashboard/assets/images/add-image-icon.jpg'}} " alt="Add Image">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="subtitle" id="subtitle"
                                           placeholder="SubTitle" type="text" class="form-control" value="{{$blog->subtitle}}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                <label for="category"
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="category" id="category"
                                           placeholder="Category" type="text" class="form-control" value="{{$blog->category}}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="created_at" id="created_at"
                                           type="text" class="form-control" value="{{$blog->created_at}}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                <label for="content"

                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="assets/images/users/{{Auth::user()->avatar ?? 'user.png'}}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="assets/images/users/{{Auth::user()->avatar ?? 'user.png'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
            ...
            <div class="scrollbar-sidebar">
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            <a href="./admin/home" class="{{(request()->segment(2)== 'home') ? 'mm-active': ''}}"><i class="lni lni-home"></i>Home</a>
                            <a href="#">

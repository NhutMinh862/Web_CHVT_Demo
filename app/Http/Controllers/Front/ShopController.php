...
class ShopController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $relatedProduct = $this->productService->getRelatedProduct($product);
    ...
    public function index(Request $request)
    {
        $categories = $this->productCategoryService->all();
        $brands = $this->brandService->all();
        $products = $this->productService->getProductOnPC($request);
        return view('front.shop.product_category', compact('products', 'categories', 'brands'));
    }
